...
class RecursoController extends \yii\web\Controller
{
    public function behaviors()
    {
        ...
        $behaviors['access'] = [
            ...
            'only' => ['index', 'create', 'update', 'resources'], // acciones a las que se aplicará el control
            'except' => [''],    // acciones a las que no se aplicará el control
            'rules' => [
                [
                    'allow' => true, // permitido o no permitido
                    'actions' => ['index', 'create', 'update', 'resources'], // acciones que siguen esta regla
    ...
    public function actionResources($idSubject)
    {
        $resources = Recurso::find()
